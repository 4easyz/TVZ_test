...
<div class="pull-right btn-group">
    <?php echo Html::a('Update', array('car/update', 'id' => $model->id), array('class' => 'btn btn-primary')); ?>
    <?php echo Html::a('Delete', array('car/delete', 'id' => $model->id), array('class' => 'btn btn-danger')); ?>
</div>
<hr />
